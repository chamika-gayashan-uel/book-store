        ...
        <div className="min-h-screen flex items-center justify-center bg-teal-50 p-4">
            <div className="w-full max-w-2xl">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex gap-2 text-xs text-gray-500">
                                <span className={`px-2 py-1 rounded ${formData.role === 'user' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100'}`}>
                                    👤 User
                                </span>
                                <span className={`px-2 py-1 rounded ${formData.role === 'author' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100'}`}>
                                    ✍️ Author
                                </span>
                                <span className={`px-2 py-1 rounded ${formData.role === 'admin' ? 'bg-red-100 text-red-700' : 'bg-gray-100'}`}>
                                    ⚙️ Admin
                                </span>
                            </div>
                        </div>
                ...
                <p className="mt-6 text-center text-xs text-gray-500">
                    ...
                    <button className="underline hover:text-gray-700">Terms</button>
                    {' '}and{' '}
