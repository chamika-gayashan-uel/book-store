...
function SwapUI(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "md", children: [(0, jsx_runtime_1.jsxs)(Modal_js_1.Modal, { hide: false, autoFocusCrossIcon: false, className: "tw-modal__swap-widget", size: isMobile ? "compact" : "wide", title: "Select Token", open: modalState.isOpen, crossContainerStyles: {
                    ...
                    if (!v) {
                ...
                }, children: [modalState.screen === "select-buy-token" && ((0, jsx_runtime_1.jsx)(select_token_ui_js_1.SelectToken, { activeWalletInfo: props.activeWalletInfo, onClose: () => {
                            setModalState((v) => ({
                                ...v,
                                isOpen: false,
                            }));
                        }, client: props.client, selectedToken: props.buyToken, setSelectedToken: (token) => {
                        ...
                        }, client: props.client, selectedToken: props.sellToken, setSelectedToken: (token) => {
                        ...
                        }, activeWalletInfo: props.activeWalletInfo }))] }), detailsModalOpen && ((0, jsx_runtime_1.jsx)(Details_js_1.DetailsModal, { client: props.client, locale: en_js_1.default, detailsModal: undefined, theme: props.theme, closeModal: () => {
                    setDetailsModalOpen(false);
                }, onDisconnect: () => {
                    props.onDisconnect?.();
                }, chains: [], connectOptions: props.connectOptions })), (0, jsx_runtime_1.jsx)(TokenSection, { onMaxClick: () => {
                ...
                } }), (0, jsx_runtime_1.jsx)(TokenSection, { onMaxClick: undefined, onWalletClick: () => {
                    setDetailsModalOpen(true);
                }, activeWalletInfo: props.activeWalletInfo, isConnected: !!props.activeWalletInfo, balance: {
                ...
                }, theme: props.theme, ...props.connectOptions })) : ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { disabled: disableContinue, fullWidth: true, onClick: () => {
