...
function LightTheme() {
    return ((0, jsx_runtime_1.jsx)(Variant, { clientId: utils_js_1.storyClient.clientId, theme: "light", buy: { chainId: 8453, amount: "0.1" } }));
}
...
function CustomTheme() {
    return ((0, jsx_runtime_1.jsx)(Variant, { clientId: utils_js_1.storyClient.clientId, buy: { chainId: 8453, amount: "0.1" }, theme: {
            type: "light",
            colors: {
                modalBg: "#FFFFF0",
                tertiaryBg: "#DBE4C9",
