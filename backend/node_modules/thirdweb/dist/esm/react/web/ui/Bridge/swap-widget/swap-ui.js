...
export function SwapUI(props) {
    ...
    return (_jsxs(Container, { p: "md", children: [_jsxs(Modal, { hide: false, autoFocusCrossIcon: false, className: "tw-modal__swap-widget", size: isMobile ? "compact" : "wide", title: "Select Token", open: modalState.isOpen, crossContainerStyles: {
                    ...
                    if (!v) {
                ...
                }, children: [modalState.screen === "select-buy-token" && (_jsx(SelectToken, { activeWalletInfo: props.activeWalletInfo, onClose: () => {
                            setModalState((v) => ({
                                ...v,
                                isOpen: false,
                            }));
                        ...
                        }, activeWalletInfo: props.activeWalletInfo }))] }), detailsModalOpen && (_jsx(DetailsModal, { client: props.client, locale: connectLocaleEn, detailsModal: undefined, theme: props.theme, closeModal: () => {
                    setDetailsModalOpen(false);
                }, onDisconnect: () => {
                    props.onDisconnect?.();
                }, chains: [], connectOptions: props.connectOptions })), _jsx(TokenSection, { onMaxClick: () => {
                ...
                } }), _jsx(TokenSection, { onMaxClick: undefined, onWalletClick: () => {
                    setDetailsModalOpen(true);
                }, activeWalletInfo: props.activeWalletInfo, isConnected: !!props.activeWalletInfo, balance: {
                ...
                }, theme: props.theme, ...props.connectOptions })) : (_jsxs(Button, { disabled: disableContinue, fullWidth: true, onClick: () => {
