...
export const Spinner = (props) => {
    ...
    return (_jsx(Svg, { style: {
            ...
            ...props.style,
        }, viewBox: "0 0 50 50", className: "tw-spinner", children: _jsx(Circle, { cx: "25", cy: "25", fill: "none", r: "20", stroke: props.color ? theme.colors[props.color] : "currentColor", strokeWidth: Number(iconSize[props.size]) > 64 ? "2" : "4" }) }));
};
// animations
