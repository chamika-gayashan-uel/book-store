...
export function DirectPayment({ paymentInfo, metadata, client, onContinue, showThirdwebBranding = true, buttonLabel, currency, }) {
    ...
    const buyNow = buttonLabel ? (_jsx(Text, { color: "primaryButtonText", size: "md", children: buttonLabel })) : (_jsxs(Container, { flex: "row", gap: "3xs", children: [_jsx(Text, { color: "primaryButtonText", size: "md", children: "Buy Now \u00B7" }), _jsx(FiatValue, { currency: currency, chain: chain, client: client, color: "primaryButtonText", size: "md", token: paymentInfo.token, tokenAmount: paymentInfo.amount })] }));
