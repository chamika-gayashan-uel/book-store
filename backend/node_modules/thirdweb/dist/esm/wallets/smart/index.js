...
async function createSmartAccount(options) {
    ...
    const account = {
        ...
        sendCalls: async (options) => {
            const { inAppWalletSendCalls } = await import("../in-app/core/eip5792/in-app-wallet-calls.js");
        ...
        getCallsStatus: async (options) => {
            const { inAppWalletGetCallsStatus } = await import("../in-app/core/eip5792/in-app-wallet-calls.js");
