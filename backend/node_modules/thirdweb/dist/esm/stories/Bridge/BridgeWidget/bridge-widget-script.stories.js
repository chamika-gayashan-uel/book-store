...
export function LightTheme() {
    return (_jsx(Variant, { clientId: storyClient.clientId, theme: "light", buy: { chainId: 8453, amount: "0.1" } }));
}
...
export function CustomTheme() {
    return (_jsx(Variant, { clientId: storyClient.clientId, buy: { chainId: 8453, amount: "0.1" }, theme: {
            type: "light",
            colors: {
                modalBg: "#FFFFF0",
                tertiaryBg: "#DBE4C9",
